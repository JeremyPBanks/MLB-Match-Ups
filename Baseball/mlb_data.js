...
exports.mlbpitchers = {
    ...
    // Format the raw data scraped through x-ray
    formatResults: function (rawData, callback) 
    {
        const totalGames = rawData.teamHome.length;
        ...
        for (let i = 0; i < totalGames; i++) 
        {
            ...
            matchups[i] = {
                ...
                pitcherAwayStats: rawData.pitcher_stats[j].trim(),
                pitcherHomeStats: rawData.pitcher_stats[j+1].trim()
            };
    ...
    getPitchers: function (game_day, callback)
    {
        const url = `https://www.mlb.com/probable-pitchers/${game_day}`;
        const selector = {
			...
			pitcher_stats: ['.probable-pitchers__pitcher-stats-summary'],
        };
